...
export default {
    ...
    getSuggestions(suggestions){
        ...
        if ((type.includes(".chasm-instruction")) && (notSymbol = type.endsWith(prefixStr)))
        {
        ...
        else if ((type.includes(".chasm-directive")) && (notSymbol = type.endsWith(prefixStr)))
        {
