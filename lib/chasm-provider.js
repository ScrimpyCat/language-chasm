...
export default {
    ...
    api: {
        ...
        directives: [
            ...
            {
                mnemonic: ".assert", description: "Assert at compile time that a given condition is true", operands: [
                    ['condition'],
                    ['condition', 'message']
                ]
            },
            {
                mnemonic: ".break", description: "Set a prefined read/write breakpoint in the program", operands: [
                    [],
                    ['offset'],
                    ['offset', 'count']
                ]
            ...
            {
                mnemonic: ".if", description: "Conditionally assemble the following codeblock when the condition is true", operands: [
                    ['expression']
                ]
            },
            {
                mnemonic: ".elseif", description: "Conditionally assemble the following codeblock when the condition is true and previous conditions are false", operands: [
                    ['expression']
                ]
            },
            {
                mnemonic: ".else", description: "Conditionally assemble the following codeblock when all previous conditions are false", operands: [
                    []
                ]
            },
            {
                mnemonic: ".endif", description: "Mark the end of an if codeblock", operands: [
                    []
                ]
            },
            {
                mnemonic: ".macro", description: "Create macro with name and optional parameters", operands: [
                    ['symbol'],
                    ['symbol', 'x'],
                    ['symbol', 'x', 'y'],
                    ['symbol', 'x', 'y', 'z']
            ...
            {
                mnemonic: ".endm", description: "Mark the end of the macro definition", operands: [
                    []
                ]
            },
            {
                mnemonic: ".nomacro", description: "Disable all macros or the macro with the specified name", operands: [
                    [],
                    ['symbol']
                ]
            },
            {
                mnemonic: ".nodefine", description: "Disable all defines or the define with the specified name", operands: [
                    [],
                    ['symbol']
                ]
            },
            {
                mnemonic: ".nolabel", description: "Disable all labels or the label with the specified name", operands: [
                    [],
                    ['symbol']
                ]
            },
            {
                mnemonic: ".noexpand", description: "Disable all symbol expansions or the symbol with the specified name", operands: [
                    [],
                    ['symbol']
                ]
            },
            {
                mnemonic: ".expand", description: "Enable all symbol expansions or the symbol with the specified name", operands: [
                    [],
                    ['symbol']
                ]
            },
            {
                mnemonic: ".bits", description: "Insert literal bit values", operands: [
                    ['value']
                ]
            },
            {
                mnemonic: ".padbits", description: "Insert remaining bits to meet padding requirement", operands: [
                    [],
                    ['value'],
                    ['value', 'size']
                ]
            ...
            {
                mnemonic: ".error", description: "Indicate a compile error", operands: [
                    ['message'],
                    ['message', 'args']
                ]
            },
            {
                mnemonic: ".savedefine", description: "Save all defines or the define with the specified name to the parent scope", operands: [
                    [],
                    ['symbol']
                ]
            },
            {
                mnemonic: ".savelabel", description: "Save all labels or the label with the specified name to the parent scope", operands: [
                    [],
                    ['symbol']
                ]
            },
            {
                mnemonic: ".savemacro", description: "Save all macros or the macro with the specified name to the parent scope", operands: [
                    [],
                    ['symbol']
                ]
            },
            {
                mnemonic: ".save", description: "Save all symbols or the symbol with the specified name to the parent scope", operands: [
                    [],
                    ['symbol']
                ]
            }
